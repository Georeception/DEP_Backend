...
class News(models.Model):
    ...
    preview_image = models.ImageField(upload_to='news/previews/', storage=MediaCloudinaryStorage())
    ...
    image = models.ImageField(upload_to='news/', storage=MediaCloudinaryStorage(), null=True, blank=True)
